          ...
          <div className=" pt-5 pb-3 border-t border-white/20">
            <div className="flex items-center justify-center flex-col md:flex-row md:justify-between gap-6">
              ...
              <div className="flex items-center gap-1.5  sm:justify-center ">
                <a
                  href="javascript:;"
                  className=" w-9 h-9 group flex justify-center items-center p-3 rounded-full bg-white "
                >
                  <svg
                ...
                >
                  <svg
                    className="w-[1.25rem] h-[0.875rem] text-gray-700 group-hover:text-indigo-600"
                    viewBox="0 0 16 12"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
